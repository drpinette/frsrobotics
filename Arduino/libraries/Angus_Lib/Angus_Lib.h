...
#define FRONT_PROXIMITY_PIN1 10
#define FRONT_PROXIMITY_PIN2 12
#define FRONT_PROXIMITY_PIN3 9
#define RIGHT_BACK_PIN 6
#define LEFT_FRONT_PIN 7
#define LEFT_BACK_PIN 5
#define WHITELINE_PIN 0 
#define ODOMETRY_PIN 8
#define EXTINGUISHER_PIN 11 
#define SITUATION_PIN 13
...
#define CANDLE_LOCATE_SPEED 100 //was 127
#define TURN_ALIGN_SPEED 100
#define EDGE_DETECT_SPEED 110
#define TURN_SPEED 150
#define TURN_ADJUST 50 //was 50 then 30 then 50 then 40 then 35
...
bool moveUntilProximity(int distance) ;
...
void turnRight90AlignRight(int speed=TURN_ALIGN_SPEED) ;
